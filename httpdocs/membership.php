  ...
  <div class="container">
        ...
        <div class="col-sm-12 col-md-10 col-md-offset-1">
          <div class="member-info-wrap">
            <div class="row">
                  ...
                  <p>You might be a graduate or certificate holder, but you still have the benefits of a student. As an automatic member, you get access to ISM CSE Recreation, ISM CSE Library and the Alumni Webportal. Because we believe as a CSE Alumni, you&#8217;ve earned it an d you can be the part by annual membership charge of Rs. 1000.</p>
                </div>
          ...
          Unlike Annual Membership, you reap benefits for life, without any additional costs to maintain your status. And any annual member can become a Lifetime member by just making a one time payment of Rs 10000.</p>
                </div>
            </div>
          </div>
        </div>
   ...
   <div class="container">
      ...
      <div class="row">
        <div class="col-sm-12 col-md-10 col-md-offset-1">
          <div class="member-info-wrap">
            <div class="row" style="font-size:32px;align:center;">
                ...
                <p style="font-weight:bold;">Account Name - CSES<br>
                  ...
                  <p> After the Payment you just have to mail us your details like Your Name, Batch, Admission Number, Current Address, Contact Number and the reciept of the payment made to csesoc@ismdhanbad.ac.in .We will Contact you soon regarding the membership confirmation and welcoming you to the family.</p>
                </div>
          </div>
        </div>
        </div>
